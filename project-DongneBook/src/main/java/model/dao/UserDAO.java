...
public class UserDAO {
	...
	public int create(User user) throws SQLException {
		...
		Object[] param = new Object[] {user.getUserId(), user.getPassword(), 
						user.getName(), user.getLocation(), user.getPhone(), 
						user.getEmail()};				
	...
	public int update(User user) throws SQLException {
		String sql = "UPDATE USERS "
					+ "SET password=?, name=?, location=?, phone=?, email=? "
					+ "WHERE user_id=?";
		Object[] param = new Object[] {user.getPassword(), user.getName(), 
					user.getLocation(), user.getPhone(), 
	...
	public User findUser(String userId) throws SQLException {
        String sql = "SELECT password, name, email, phone, location "
        			+ "FROM USERS "
        			+ "WHERE user_id=? ";              
	...
	public List<User> findUserList() throws SQLException {
        String sql = "SELECT user_id, name, location, email " 
        		   + "FROM USERS "
        		   + "ORDER BY user_id";

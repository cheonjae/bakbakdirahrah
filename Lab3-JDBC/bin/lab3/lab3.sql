DROP TABLE DEPT191018 CASCADE CONSTRAINTS;
DROP TABLE EMP191018 CASCADE CONSTRAINTS;

CREATE TABLE DEPT191018 (
	DEPTNO NUMBER(2) PRIMARY KEY,
	DNAME VARCHAR2(14),
	LOC VARCHAR2(13),
	MANAGER NUMBER(4) ) ;

CREATE TABLE EMP191018 (
	...
	SAL NUMBER(7,2),
	COMM NUMBER(7,2),
	DEPTNO NUMBER(2) REFERENCES DEPT191018(DEPTNO));

INSERT INTO DEPT191018 VALUES
...
ALTER TABLE DEPT191018 ADD CONSTRAINT FK_DEPT191018 FOREIGN KEY(MANAGER) REFERENCES EMP191018(EMPNO);
